...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('object_permissions_objectpermission', (
        ...
        db.send_create_signal('object_permissions', ['ObjectPermission'])


    def backwards(self, orm):
        
        # Deleting model 'ObjectPermission'
        db.delete_table('object_permissions_objectpermission')
