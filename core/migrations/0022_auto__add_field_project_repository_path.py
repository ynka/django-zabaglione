...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.repository_path'
        db.add_column('core_project', 'repository_path', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.repository_path'
        db.delete_column('core_project', 'repository_path')
    ...
    models = {
        ...
        'core.project': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'repository_path': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'core.relatedtickets': {
