...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_attachment', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Attachment.content_type'
        db.alter_column('core_attachment', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Attachment.object_id'
        db.alter_column('core_attachment', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Attachment.content_type'
        db.alter_column('core_attachment', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))
