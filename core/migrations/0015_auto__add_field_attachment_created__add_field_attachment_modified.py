...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attachment.created'
        db.add_column('core_attachment', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Attachment.modified'
        db.add_column('core_attachment', 'modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Attachment.created'
        db.delete_column('core_attachment', 'created')

        # Deleting field 'Attachment.modified'
        db.delete_column('core_attachment', 'modified')
