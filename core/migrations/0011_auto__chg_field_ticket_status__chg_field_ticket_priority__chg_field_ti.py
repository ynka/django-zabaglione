...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_ticket', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Status'], null=True, blank=True))

        # Changing field 'Ticket.priority'
        db.alter_column('core_ticket', 'priority_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Priority'], null=True, blank=True))

        # Changing field 'Ticket.version'
        db.alter_column('core_ticket', 'version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Version'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Ticket.status'
        db.alter_column('core_ticket', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Status']))

        # Changing field 'Ticket.priority'
        db.alter_column('core_ticket', 'priority_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Priority']))

        # Changing field 'Ticket.version'
        db.alter_column('core_ticket', 'version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Version']))
