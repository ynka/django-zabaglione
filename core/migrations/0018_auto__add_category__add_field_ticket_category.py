...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_ticket', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Category'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_ticket', 'category_id')
