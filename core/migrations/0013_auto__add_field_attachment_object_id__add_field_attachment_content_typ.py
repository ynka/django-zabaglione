...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_attachment', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'Attachment.content_type'
        db.add_column('core_attachment', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Attachment.object_id'
        db.delete_column('core_attachment', 'object_id')

        # Deleting field 'Attachment.content_type'
        db.delete_column('core_attachment', 'content_type_id')
