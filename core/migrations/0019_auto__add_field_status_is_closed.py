...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Status.is_closed'
        db.add_column('core_status', 'is_closed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Status.is_closed'
        db.delete_column('core_status', 'is_closed')
