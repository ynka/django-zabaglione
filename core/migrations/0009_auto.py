...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field assigned_to on 'Ticket'
        db.delete_table('core_ticket_assigned_to')

        # Adding M2M table for field workers on 'Ticket'
        db.create_table('core_ticket_workers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ticket', models.ForeignKey(orm['core.ticket'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('core_ticket_workers', ['ticket_id', 'user_id'])
    
    
    def backwards(self, orm):
        
        # Adding M2M table for field assigned_to on 'Ticket'
        db.create_table('core_ticket_assigned_to', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ticket', models.ForeignKey(orm['core.ticket'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('core_ticket_assigned_to', ['ticket_id', 'user_id'])

        # Removing M2M table for field workers on 'Ticket'
        db.delete_table('core_ticket_workers')
    ...
    models = {
        ...
        'core.ticket': {
            ...
            'workers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'tickets'", 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
        'core.version': {
