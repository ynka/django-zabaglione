...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.repository_path'
        db.alter_column('core_project', 'repository_path', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))


    def backwards(self, orm):
        
        # Changing field 'Project.repository_path'
        db.alter_column('core_project', 'repository_path', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True))
