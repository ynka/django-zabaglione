...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RelatedTickets'
        db.create_table('core_relatedtickets', (
            ('second', self.gf('django.db.models.fields.related.ForeignKey')(related_name='second_set', to=orm['core.Ticket'])),
            ('relation', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first', self.gf('django.db.models.fields.related.ForeignKey')(related_name='first_set', to=orm['core.Ticket'])),
        ))
        db.send_create_signal('core', ['RelatedTickets'])

        # Removing M2M table for field related on 'Ticket'
        db.delete_table('core_ticket_related')
    
    
    def backwards(self, orm):
        
        # Deleting model 'RelatedTickets'
        db.delete_table('core_relatedtickets')

        # Adding M2M table for field related on 'Ticket'
        db.create_table('core_ticket_related', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_ticket', models.ForeignKey(orm['core.ticket'], null=False)),
            ('to_ticket', models.ForeignKey(orm['core.ticket'], null=False))
        ))
        db.create_unique('core_ticket_related', ['from_ticket_id', 'to_ticket_id'])
    ...
    models = {
        ...
        'core.ticket': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Project']"}),
            'related': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['core.Ticket']", 'through': "orm['core.RelatedTickets']", 'symmetrical': 'False'}),
